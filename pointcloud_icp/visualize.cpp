...
#include <pcl/common/transforms.h>  // Required for transformPointCloud
#include <Eigen/Dense>
...
int main()
{
    ...
    // Shift the original source cloud a bit for visibility
    Eigen::Matrix4f offset = Eigen::Matrix4f::Identity();
    offset(0, 3) = -0.05f;  // shift in X by -5 cm
